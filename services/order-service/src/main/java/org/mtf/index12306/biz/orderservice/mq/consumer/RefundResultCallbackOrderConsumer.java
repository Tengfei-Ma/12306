package org.mtf.index12306.biz.orderservice.mq.consumer;

import lombok.RequiredArgsConstructor;
import lombok.extern.slf4j.Slf4j;
import org.apache.rocketmq.spring.annotation.RocketMQMessageListener;
import org.apache.rocketmq.spring.core.RocketMQListener;
import org.mtf.index12306.biz.orderservice.common.constant.OrderRocketMQConstant;
...
import org.mtf.index12306.biz.orderservice.mq.domain.MessageWrapper;
import org.mtf.index12306.biz.orderservice.mq.event.RefundResultCallbackOrderEvent;
...
public class RefundResultCallbackOrderConsumer implements RocketMQListener<MessageWrapper<RefundResultCallbackOrderEvent>> {
    ...
    public void onMessage(MessageWrapper<RefundResultCallbackOrderEvent> message) {
        ...
        List<OrderItemRespDTO> partialRefundTicketDetailList = refundResultCallbackOrderEvent.getPartialRefundTicketDetailList();
