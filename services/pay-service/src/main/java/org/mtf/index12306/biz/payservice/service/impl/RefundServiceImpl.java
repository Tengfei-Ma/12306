...
import org.mtf.index12306.biz.payservice.convert.RefundRequestConvert;
...
import org.mtf.index12306.biz.payservice.dao.mapper.RefundMapper;
...
import org.mtf.index12306.biz.payservice.dto.resp.RefundCreateDTO;
...
public class RefundServiceImpl extends ServiceImpl<RefundMapper, RefundDO> implements RefundService {
    ...
    public RefundRespDTO commonRefund(RefundReqDTO requestParam) {
        ...
        int refundUpdateResult = baseMapper.update(refundDO, refundUpdateWrapper);
