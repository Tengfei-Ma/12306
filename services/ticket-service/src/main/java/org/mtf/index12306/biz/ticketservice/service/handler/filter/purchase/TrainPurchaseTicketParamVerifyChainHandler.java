...
import org.mtf.index12306.biz.ticketservice.dao.entity.TrainDO;
import org.mtf.index12306.biz.ticketservice.dao.entity.TrainStationDO;
import org.mtf.index12306.biz.ticketservice.dao.mapper.TrainMapper;
import org.mtf.index12306.biz.ticketservice.dao.mapper.TrainStationMapper;
...
import org.mtf.index12306.framework.starter.common.toolkit.EnvironmentUtil;
...
import static org.mtf.index12306.biz.ticketservice.common.constant.RedisKeyConstant.TRAIN_INFO;
import static org.mtf.index12306.biz.ticketservice.common.constant.RedisKeyConstant.TRAIN_STATION_STOPOVER_DETAIL;
...
public class TrainPurchaseTicketParamVerifyChainHandler implements TrainPurchaseTicketChainFilter<TicketPurchaseReqDTO> {
