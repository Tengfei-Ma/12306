package org.mtf.index12306.biz.ticketservice.service.handler.tokenbucket;
...
import org.mtf.index12306.framework.starter.bases.Singleton;
import org.mtf.index12306.framework.starter.cache.DistributedCache;
import org.mtf.index12306.framework.starter.common.toolkit.Assert;
...
public final class TicketAvailabilityTokenBucket {
     ...
     */
    public TokenResultDTO takeTokenFromBucket(TicketPurchaseReqDTO requestParam) {
     ...
     */
    public void delTokenInBucket(TicketPurchaseReqDTO requestParam) {
        StringRedisTemplate stringRedisTemplate = (StringRedisTemplate) distributedCache.getInstance();
        String tokenBucketHashKey = TICKET_AVAILABILITY_TOKEN_BUCKET + requestParam.getTrainId();
