package org.mtf.index12306.biz.ticketservice.service.handler;
...
import org.mtf.index12306.biz.ticketservice.common.enums.VehicleSeatTypeEnum;
import org.mtf.index12306.biz.ticketservice.common.enums.VehicleTypeEnum;
import org.mtf.index12306.biz.ticketservice.dto.domain.PurchaseTicketPassengerDetailDTO;
import org.mtf.index12306.biz.ticketservice.dto.domain.TrainSeatBaseDTO;
import org.mtf.index12306.biz.ticketservice.service.SeatService;
import org.mtf.index12306.biz.ticketservice.service.handler.base.AbstractTrainPurchaseTicketTemplate;
import org.mtf.index12306.biz.ticketservice.service.handler.base.BitMapCheckSeat;
import org.mtf.index12306.biz.ticketservice.service.handler.base.BitMapCheckSeatStatusFactory;
import org.mtf.index12306.biz.ticketservice.service.handler.dto.SelectSeatDTO;
import org.mtf.index12306.biz.ticketservice.service.handler.dto.TrainPurchaseTicketRespDTO;
import org.mtf.index12306.biz.ticketservice.service.handler.select.SeatSelection;
import org.mtf.index12306.biz.ticketservice.toolkit.CarriageVacantSeatCalculateUtil;
import org.mtf.index12306.biz.ticketservice.toolkit.SeatNumberUtil;
...
import static org.mtf.index12306.biz.ticketservice.service.handler.base.BitMapCheckSeatStatusFactory.TRAIN_BUSINESS;
