package org.mtf.index12306.biz.ticketservice.service.handler.select;
...
import org.mtf.index12306.biz.ticketservice.dao.entity.TrainStationPriceDO;
import org.mtf.index12306.biz.ticketservice.dao.mapper.TrainStationPriceMapper;
...
import org.mtf.index12306.biz.ticketservice.remote.UserRemoteService;
import org.mtf.index12306.biz.ticketservice.remote.dto.PassengerRespDTO;
...
import org.mtf.index12306.framework.starter.convention.exception.RemoteException;
...
public final class TrainSeatTypeSelector {
    ...
    public List<TrainPurchaseTicketRespDTO> select(Integer trainType, TicketPurchaseReqDTO requestParam) {
    ...
    private List<TrainPurchaseTicketRespDTO> distributeSeats(Integer trainType, Integer seatType, TicketPurchaseReqDTO requestParam, List<PurchaseTicketPassengerDetailDTO> passengerSeatDetails) {
