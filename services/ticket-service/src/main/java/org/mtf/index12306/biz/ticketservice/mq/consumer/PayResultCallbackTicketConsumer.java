...
import org.mtf.index12306.biz.ticketservice.common.enums.SeatStatusEnum;
import org.mtf.index12306.biz.ticketservice.dao.entity.SeatDO;
import org.mtf.index12306.biz.ticketservice.dao.mapper.SeatMapper;
import org.mtf.index12306.biz.ticketservice.mq.domain.MessageWrapper;
import org.mtf.index12306.biz.ticketservice.mq.event.PayResultCallbackTicketEvent;
...
public class PayResultCallbackTicketConsumer implements RocketMQListener<MessageWrapper<PayResultCallbackTicketEvent>> {
    ...
    public void onMessage(MessageWrapper<PayResultCallbackTicketEvent> message) {
        Result<OrderInfoRespDTO> ticketOrderDetailResult;
        try {
            ticketOrderDetailResult = orderRemoteService.queryTicketOrderByOrderSn(message.getMessage().getOrderSn());
        ...
        for (OrderItemRespDTO each : ticketOrderDetail.getPassengerDetails()) {
